...
Describe 'Read-HtmlTable' {
    ...
    Context 'Internet Tables' {
        ...
        It 'https://en.wikipedia.org/wiki/Color' {
            ...
            $Expected =
                [pscustomobject]@{Color = $Null, 'Red'; "Wavelength`r`ninterval" = '~ 700–635 nm'; "Frequency`r`ninterval" = '~ 430–480 THz'},
                [pscustomobject]@{Color = $Null, 'Orange'; "Wavelength`r`ninterval" = '~ 635–590 nm'; "Frequency`r`ninterval" = '~ 480–510 THz'},
                [pscustomobject]@{Color = $Null, 'Yellow'; "Wavelength`r`ninterval" = '~ 590–560 nm'; "Frequency`r`ninterval" = '~ 510–540 THz'},
                [pscustomobject]@{Color = $Null, 'Green'; "Wavelength`r`ninterval" = '~ 560–520 nm'; "Frequency`r`ninterval" = '~ 540–580 THz'},
                [pscustomobject]@{Color = $Null, 'Cyan'; "Wavelength`r`ninterval" = '~ 520–490 nm'; "Frequency`r`ninterval" = '~ 580–610 THz'},
                [pscustomobject]@{Color = $Null, 'Blue'; "Wavelength`r`ninterval" = '~ 490–450 nm'; "Frequency`r`ninterval" = '~ 610–670 THz'},
                [pscustomobject]@{Color = $Null, 'Violet'; "Wavelength`r`ninterval" = '~ 450–400 nm'; "Frequency`r`ninterval" = '~ 670–750 THz'}
        ...
        It 'https://en.wikipedia.org/wiki/Web_colors' {
            ...
            $Expected =
                [pscustomobject]@{Name = 'White'; "Hex`r`n(RGB)" = '#FFFFFF'; "Red`r`n(RGB)" = '100%'; "Green`r`n(RGB)" = '100%'; "Blue`r`n(RGB)" = '100%'; "Hue`r`n(HSL/HSV)" = '0°'; "Satur.`r`n(HSL)" = '0%'; "Light`r`n(HSL)" = '100%'; "Satur.`r`n(HSV)" = '0%'; "Value`r`n(HSV)" = '100%'; 'CGA number (name); alias' = '15 (white)'},
                [pscustomobject]@{Name = 'Silver'; "Hex`r`n(RGB)" = '#C0C0C0'; "Red`r`n(RGB)" = '75%'; "Green`r`n(RGB)" = '75%'; "Blue`r`n(RGB)" = '75%'; "Hue`r`n(HSL/HSV)" = '0°'; "Satur.`r`n(HSL)" = '0%'; "Light`r`n(HSL)" = '75%'; "Satur.`r`n(HSV)" = '0%'; "Value`r`n(HSV)" = '75%'; 'CGA number (name); alias' = '07 (light gray)'},
                [pscustomobject]@{Name = 'Gray'; "Hex`r`n(RGB)" = '#808080'; "Red`r`n(RGB)" = '50%'; "Green`r`n(RGB)" = '50%'; "Blue`r`n(RGB)" = '50%'; "Hue`r`n(HSL/HSV)" = '0°'; "Satur.`r`n(HSL)" = '0%'; "Light`r`n(HSL)" = '50%'; "Satur.`r`n(HSV)" = '0%'; "Value`r`n(HSV)" = '50%'; 'CGA number (name); alias' = '08 (dark gray)'},
                [pscustomobject]@{Name = 'Black'; "Hex`r`n(RGB)" = '#000000'; "Red`r`n(RGB)" = '0%'; "Green`r`n(RGB)" = '0%'; "Blue`r`n(RGB)" = '0%'; "Hue`r`n(HSL/HSV)" = '0°'; "Satur.`r`n(HSL)" = '0%'; "Light`r`n(HSL)" = '0%'; "Satur.`r`n(HSV)" = '0%'; "Value`r`n(HSV)" = '0%'; 'CGA number (name); alias' = '00 (black)'},
                [pscustomobject]@{Name = 'Red'; "Hex`r`n(RGB)" = '#FF0000'; "Red`r`n(RGB)" = '100%'; "Green`r`n(RGB)" = '0%'; "Blue`r`n(RGB)" = '0%'; "Hue`r`n(HSL/HSV)" = '0°'; "Satur.`r`n(HSL)" = '100%'; "Light`r`n(HSL)" = '50%'; "Satur.`r`n(HSV)" = '100%'; "Value`r`n(HSV)" = '100%'; 'CGA number (name); alias' = '12 (high red)'},
                [pscustomobject]@{Name = 'Maroon'; "Hex`r`n(RGB)" = '#800000'; "Red`r`n(RGB)" = '50%'; "Green`r`n(RGB)" = '0%'; "Blue`r`n(RGB)" = '0%'; "Hue`r`n(HSL/HSV)" = '0°'; "Satur.`r`n(HSL)" = '100%'; "Light`r`n(HSL)" = '25%'; "Satur.`r`n(HSV)" = '100%'; "Value`r`n(HSV)" = '50%'; 'CGA number (name); alias' = '04 (low red)'},
                [pscustomobject]@{Name = 'Yellow'; "Hex`r`n(RGB)" = '#FFFF00'; "Red`r`n(RGB)" = '100%'; "Green`r`n(RGB)" = '100%'; "Blue`r`n(RGB)" = '0%'; "Hue`r`n(HSL/HSV)" = '60°'; "Satur.`r`n(HSL)" = '100%'; "Light`r`n(HSL)" = '50%'; "Satur.`r`n(HSV)" = '100%'; "Value`r`n(HSV)" = '100%'; 'CGA number (name); alias' = '14 (yellow)'},
                [pscustomobject]@{Name = 'Olive'; "Hex`r`n(RGB)" = '#808000'; "Red`r`n(RGB)" = '50%'; "Green`r`n(RGB)" = '50%'; "Blue`r`n(RGB)" = '0%'; "Hue`r`n(HSL/HSV)" = '60°'; "Satur.`r`n(HSL)" = '100%'; "Light`r`n(HSL)" = '25%'; "Satur.`r`n(HSV)" = '100%'; "Value`r`n(HSV)" = '50%'; 'CGA number (name); alias' = '06 (brown)'},
                [pscustomobject]@{Name = 'Lime'; "Hex`r`n(RGB)" = '#00FF00'; "Red`r`n(RGB)" = '0%'; "Green`r`n(RGB)" = '100%'; "Blue`r`n(RGB)" = '0%'; "Hue`r`n(HSL/HSV)" = '120°'; "Satur.`r`n(HSL)" = '100%'; "Light`r`n(HSL)" = '50%'; "Satur.`r`n(HSV)" = '100%'; "Value`r`n(HSV)" = '100%'; 'CGA number (name); alias' = '10 (high green); green'},
                [pscustomobject]@{Name = 'Green'; "Hex`r`n(RGB)" = '#008000'; "Red`r`n(RGB)" = '0%'; "Green`r`n(RGB)" = '50%'; "Blue`r`n(RGB)" = '0%'; "Hue`r`n(HSL/HSV)" = '120°'; "Satur.`r`n(HSL)" = '100%'; "Light`r`n(HSL)" = '25%'; "Satur.`r`n(HSV)" = '100%'; "Value`r`n(HSV)" = '50%'; 'CGA number (name); alias' = '02 (low green)'},
                [pscustomobject]@{Name = 'Aqua'; "Hex`r`n(RGB)" = '#00FFFF'; "Red`r`n(RGB)" = '0%'; "Green`r`n(RGB)" = '100%'; "Blue`r`n(RGB)" = '100%'; "Hue`r`n(HSL/HSV)" = '180°'; "Satur.`r`n(HSL)" = '100%'; "Light`r`n(HSL)" = '50%'; "Satur.`r`n(HSV)" = '100%'; "Value`r`n(HSV)" = '100%'; 'CGA number (name); alias' = '11 (high cyan); cyan'},
                [pscustomobject]@{Name = 'Teal'; "Hex`r`n(RGB)" = '#008080'; "Red`r`n(RGB)" = '0%'; "Green`r`n(RGB)" = '50%'; "Blue`r`n(RGB)" = '50%'; "Hue`r`n(HSL/HSV)" = '180°'; "Satur.`r`n(HSL)" = '100%'; "Light`r`n(HSL)" = '25%'; "Satur.`r`n(HSV)" = '100%'; "Value`r`n(HSV)" = '50%'; 'CGA number (name); alias' = '03 (low cyan)'},
                [pscustomobject]@{Name = 'Blue'; "Hex`r`n(RGB)" = '#0000FF'; "Red`r`n(RGB)" = '0%'; "Green`r`n(RGB)" = '0%'; "Blue`r`n(RGB)" = '100%'; "Hue`r`n(HSL/HSV)" = '240°'; "Satur.`r`n(HSL)" = '100%'; "Light`r`n(HSL)" = '50%'; "Satur.`r`n(HSV)" = '100%'; "Value`r`n(HSV)" = '100%'; 'CGA number (name); alias' = '09 (high blue)'},
                [pscustomobject]@{Name = 'Navy'; "Hex`r`n(RGB)" = '#000080'; "Red`r`n(RGB)" = '0%'; "Green`r`n(RGB)" = '0%'; "Blue`r`n(RGB)" = '50%'; "Hue`r`n(HSL/HSV)" = '240°'; "Satur.`r`n(HSL)" = '100%'; "Light`r`n(HSL)" = '25%'; "Satur.`r`n(HSV)" = '100%'; "Value`r`n(HSV)" = '50%'; 'CGA number (name); alias' = '01 (low blue)'},
                [pscustomobject]@{Name = 'Fuchsia'; "Hex`r`n(RGB)" = '#FF00FF'; "Red`r`n(RGB)" = '100%'; "Green`r`n(RGB)" = '0%'; "Blue`r`n(RGB)" = '100%'; "Hue`r`n(HSL/HSV)" = '300°'; "Satur.`r`n(HSL)" = '100%'; "Light`r`n(HSL)" = '50%'; "Satur.`r`n(HSV)" = '100%'; "Value`r`n(HSV)" = '100%'; 'CGA number (name); alias' = '13 (high magenta); magenta'},
                [pscustomobject]@{Name = 'Purple'; "Hex`r`n(RGB)" = '#800080'; "Red`r`n(RGB)" = '50%'; "Green`r`n(RGB)" = '0%'; "Blue`r`n(RGB)" = '50%'; "Hue`r`n(HSL/HSV)" = '300°'; "Satur.`r`n(HSL)" = '100%'; "Light`r`n(HSL)" = '25%'; "Satur.`r`n(HSV)" = '100%'; "Value`r`n(HSV)" = '50%'; 'CGA number (name); alias' = '05 (low magenta)'}
        ...
        It 'https://www.intel.com/content/www/us/en/products/details/nuc/kits.html-' {
            ...
            $Expected =
                [pscustomobject]@{'Product Name' = 'Intel® NUC 12 Extreme Kit - NUC12DCMi9'; Status = 'Launched'; 'Processor Included' = 'Intel® Core™ i9-12900 Processor (30M Cache, up to 5.10 GHz)'; 'Graphics Output' = '2x Thunderbolt 4, HDMI 2.0b'; 'Integrated Wireless‡' = 'Intel® Wi-Fi 6E AX211(Gig+)'; Price = $Null},
                [pscustomobject]@{'Product Name' = 'Intel® NUC 12 Extreme Kit - NUC12DCMi7'; Status = 'Launched'; 'Processor Included' = 'Intel® Core™ i7-12700 Processor (25M Cache, up to 4.90 GHz)'; 'Graphics Output' = '2x Thunderbolt 4, HDMI 2.0b'; 'Integrated Wireless‡' = 'Intel® Wi-Fi 6E AX211(Gig+)'; Price = $Null}
